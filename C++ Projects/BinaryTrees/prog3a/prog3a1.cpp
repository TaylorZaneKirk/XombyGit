...
int main ()
{
  ...
  cin.get ( );
    ...
    //test SwapTrees
  B.SwapTrees(B2);
  cout <<"The tree B2 after swapping it with B - should be same as above:  " << endl ;
  B.ShiftToRoot( );
  DoPrintInOrder(B2);
  cout << endl;
  cout << "Hit enter to continue" << endl ;
  ...
  cin.get ( );
    ...
    //now print out B2
  cout << "The tree B2 before swapping it with B's left subtree - It should be empty:  " << endl ;
  B2.ShiftToRoot( );
  DoPrintInOrder(B2);
  cout << endl;
  cout << "Hit enter to continue" << endl ;
